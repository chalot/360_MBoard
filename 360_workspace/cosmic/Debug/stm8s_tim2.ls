 ...
 553  00d5 c65308        	ld	a,21256
 554  00d8 a4fc          	and	a,#252
 555  00da c75308        	ld	21256,a
 ...
 913  020f c65309        	ld	a,21257
 914  0212 a4fc          	and	a,#252
 915  0214 c75309        	ld	21257,a
 916                     ; 187     TIM2->CCER2 |= (uint8_t)((uint8_t)(TIM2_OutputState & TIM2_CCER2_CC3E) |  
 916                     ; 188                              (uint8_t)(TIM2_OCPolarity & TIM2_CCER2_CC3P));
 ...
 924  0223 ca5309        	or	a,21257
 925  0226 c75309        	ld	21257,a
 926                     ; 191     TIM2->CCMR3 = (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~TIM2_CCMR_OCM)) |
 926                     ; 192                             (uint8_t)TIM2_OCMode);
 928  0229 c65307        	ld	a,21255
 929  022c a48f          	and	a,#143
 930  022e 1a02          	or	a,(OFST+1,sp)
 931  0230 c75307        	ld	21255,a
 932                     ; 195     TIM2->CCR3H = (uint8_t)(TIM2_Pulse >> 8);
 934  0233 7b06          	ld	a,(OFST+5,sp)
 935  0235 c75313        	ld	21267,a
 936                     ; 196     TIM2->CCR3L = (uint8_t)(TIM2_Pulse);
 938  0238 7b07          	ld	a,(OFST+6,sp)
 939  023a c75314        	ld	21268,a
 940                     ; 198 }
 943  023d 5b03          	addw	sp,#3
 944  023f 81            	ret
1138                     ; 210 void TIM2_ICInit(TIM2_Channel_TypeDef TIM2_Channel,
1138                     ; 211                  TIM2_ICPolarity_TypeDef TIM2_ICPolarity,
1138                     ; 212                  TIM2_ICSelection_TypeDef TIM2_ICSelection,
1138                     ; 213                  TIM2_ICPSC_TypeDef TIM2_ICPrescaler,
1138                     ; 214                  uint8_t TIM2_ICFilter)
1138                     ; 215 {
1139                     	switch	.text
1140  0240               _TIM2_ICInit:
1142  0240 89            	pushw	x
1143       00000000      OFST:	set	0
1146                     ; 217     assert_param(IS_TIM2_CHANNEL_OK(TIM2_Channel));
...
1169  0262               L211:
1170                     ; 218     assert_param(IS_TIM2_IC_POLARITY_OK(TIM2_ICPolarity));
...
1189  027f               L021:
1190                     ; 219     assert_param(IS_TIM2_IC_SELECTION_OK(TIM2_ICSelection));
...
1213  02a4               L621:
1214                     ; 220     assert_param(IS_TIM2_IC_PRESCALER_OK(TIM2_ICPrescaler));
...
1239  02cd               L431:
1240                     ; 221     assert_param(IS_TIM2_IC_FILTER_OK(TIM2_ICFilter));
...
1256  02e6               L041:
1257                     ; 223     if (TIM2_Channel == TIM2_CHANNEL_1)
1259  02e6 0d01          	tnz	(OFST+1,sp)
1260  02e8 2614          	jrne	L304
1261                     ; 226         TI1_Config((uint8_t)TIM2_ICPolarity,
1261                     ; 227                    (uint8_t)TIM2_ICSelection,
1261                     ; 228                    (uint8_t)TIM2_ICFilter);
...
1271  02f6 84            	pop	a
1272                     ; 231         TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
1274  02f7 7b06          	ld	a,(OFST+6,sp)
1275  02f9 cd08c3        	call	_TIM2_SetIC1Prescaler
1278  02fc 202c          	jra	L504
1279  02fe               L304:
1280                     ; 233     else if (TIM2_Channel == TIM2_CHANNEL_2)
1282  02fe 7b01          	ld	a,(OFST+1,sp)
1283  0300 a101          	cp	a,#1
1284  0302 2614          	jrne	L704
1285                     ; 236         TI2_Config((uint8_t)TIM2_ICPolarity,
1285                     ; 237                    (uint8_t)TIM2_ICSelection,
1285                     ; 238                    (uint8_t)TIM2_ICFilter);
...
1295  0310 84            	pop	a
1296                     ; 241         TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
1298  0311 7b06          	ld	a,(OFST+6,sp)
1299  0313 cd08f2        	call	_TIM2_SetIC2Prescaler
1302  0316 2012          	jra	L504
1303  0318               L704:
1304                     ; 246         TI3_Config((uint8_t)TIM2_ICPolarity,
1304                     ; 247                    (uint8_t)TIM2_ICSelection,
1304                     ; 248                    (uint8_t)TIM2_ICFilter);
...
1314  0324 84            	pop	a
1315                     ; 251         TIM2_SetIC3Prescaler(TIM2_ICPrescaler);
...
1324  032a 85            	popw	x
1325  032b 81            	ret
1422                     ; 265 void TIM2_PWMIConfig(TIM2_Channel_TypeDef TIM2_Channel,
1422                     ; 266                      TIM2_ICPolarity_TypeDef TIM2_ICPolarity,
1422                     ; 267                      TIM2_ICSelection_TypeDef TIM2_ICSelection,
1422                     ; 268                      TIM2_ICPSC_TypeDef TIM2_ICPrescaler,
1422                     ; 269                      uint8_t TIM2_ICFilter)
1422                     ; 270 {
1423                     	switch	.text
...
1431                     ; 271     uint8_t icpolarity = (uint8_t)TIM2_ICPOLARITY_RISING;
1433                     ; 272     uint8_t icselection = (uint8_t)TIM2_ICSELECTION_DIRECTTI;
1435                     ; 275     assert_param(IS_TIM2_PWMI_CHANNEL_OK(TIM2_Channel));
...
1455  034a               L051:
1456                     ; 276     assert_param(IS_TIM2_IC_POLARITY_OK(TIM2_ICPolarity));
...
1475  0367               L651:
1476                     ; 277     assert_param(IS_TIM2_IC_SELECTION_OK(TIM2_ICSelection));
...
1499  038c               L461:
1500                     ; 278     assert_param(IS_TIM2_IC_PRESCALER_OK(TIM2_ICPrescaler));
...
1525  03b5               L271:
1526                     ; 281     if (TIM2_ICPolarity != TIM2_ICPOLARITY_FALLING)
1528  03b5 7b04          	ld	a,(OFST+2,sp)
1529  03b7 a144          	cp	a,#68
1530  03b9 2706          	jreq	L164
1531                     ; 283         icpolarity = (uint8_t)TIM2_ICPOLARITY_FALLING;
1533  03bb a644          	ld	a,#68
1534  03bd 6b01          	ld	(OFST-1,sp),a
1536  03bf 2002          	jra	L364
1537  03c1               L164:
1538                     ; 287         icpolarity = (uint8_t)TIM2_ICPOLARITY_RISING;
1540  03c1 0f01          	clr	(OFST-1,sp)
1541  03c3               L364:
1542                     ; 291     if (TIM2_ICSelection == TIM2_ICSELECTION_DIRECTTI)
1544  03c3 7b07          	ld	a,(OFST+5,sp)
1545  03c5 a101          	cp	a,#1
1546  03c7 2606          	jrne	L564
1547                     ; 293         icselection = (uint8_t)TIM2_ICSELECTION_INDIRECTTI;
1549  03c9 a602          	ld	a,#2
1550  03cb 6b02          	ld	(OFST+0,sp),a
1552  03cd 2004          	jra	L764
1553  03cf               L564:
1554                     ; 297         icselection = (uint8_t)TIM2_ICSELECTION_DIRECTTI;
1556  03cf a601          	ld	a,#1
1557  03d1 6b02          	ld	(OFST+0,sp),a
1558  03d3               L764:
1559                     ; 300     if (TIM2_Channel == TIM2_CHANNEL_1)
1561  03d3 0d03          	tnz	(OFST+1,sp)
1562  03d5 2626          	jrne	L174
1563                     ; 303         TI1_Config((uint8_t)TIM2_ICPolarity, (uint8_t)TIM2_ICSelection,
1563                     ; 304                    (uint8_t)TIM2_ICFilter);
...
1573  03e3 84            	pop	a
1574                     ; 307         TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
1576  03e4 7b08          	ld	a,(OFST+6,sp)
1577  03e6 cd08c3        	call	_TIM2_SetIC1Prescaler
1579                     ; 310         TI2_Config(icpolarity, icselection, TIM2_ICFilter);
...
1589  03f5 84            	pop	a
1590                     ; 313         TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
1592  03f6 7b08          	ld	a,(OFST+6,sp)
1593  03f8 cd08f2        	call	_TIM2_SetIC2Prescaler
1596  03fb 2024          	jra	L374
1597  03fd               L174:
1598                     ; 318         TI2_Config((uint8_t)TIM2_ICPolarity, (uint8_t)TIM2_ICSelection,
1598                     ; 319                    (uint8_t)TIM2_ICFilter);
...
1608  0409 84            	pop	a
1609                     ; 322         TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
1611  040a 7b08          	ld	a,(OFST+6,sp)
1612  040c cd08f2        	call	_TIM2_SetIC2Prescaler
1614                     ; 325         TI1_Config((uint8_t)icpolarity, icselection, (uint8_t)TIM2_ICFilter);
...
1624  041b 84            	pop	a
1625                     ; 328         TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
...
1735  044d 84            	pop	a
1736  044e 81            	ret
1816                     ; 369 void TIM2_ITConfig(TIM2_IT_TypeDef TIM2_IT, FunctionalState NewState)
1816                     ; 370 {
1817                     	switch	.text
1818  044f               _TIM2_ITConfig:
1820  044f 89            	pushw	x
1821       00000000      OFST:	set	0
1824                     ; 372     assert_param(IS_TIM2_IT_OK(TIM2_IT));
...
1843  046c               L012:
1844                     ; 373     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
1863  0489               L612:
1864                     ; 375     if (NewState != DISABLE)
1866  0489 0d02          	tnz	(OFST+2,sp)
1867  048b 270a          	jreq	L565
1868                     ; 378         TIM2->IER |= (uint8_t)TIM2_IT;
1870  048d c65301        	ld	a,21249
1871  0490 1a01          	or	a,(OFST+1,sp)
1872  0492 c75301        	ld	21249,a
1874  0495 2009          	jra	L765
1875  0497               L565:
1876                     ; 383         TIM2->IER &= (uint8_t)(~TIM2_IT);
1878  0497 7b01          	ld	a,(OFST+1,sp)
1879  0499 43            	cpl	a
1880  049a c45301        	and	a,21249
1881  049d c75301        	ld	21249,a
1882  04a0               L765:
1883                     ; 385 }
1886  04a0 85            	popw	x
1887  04a1 81            	ret
1924                     ; 394 void TIM2_UpdateDisableConfig(FunctionalState NewState)
1924                     ; 395 {
1925                     	switch	.text
1926  04a2               _TIM2_UpdateDisableConfig:
1928  04a2 88            	push	a
1929       00000000      OFST:	set	0
1932                     ; 397     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1934  04a3 4d            	tnz	a
...
1950  04bd               L622:
1951                     ; 400     if (NewState != DISABLE)
1953  04bd 0d01          	tnz	(OFST+1,sp)
1954  04bf 2706          	jreq	L706
1955                     ; 402         TIM2->CR1 |= (uint8_t)TIM2_CR1_UDIS;
1957  04c1 72125300      	bset	21248,#1
1959  04c5 2004          	jra	L116
1960  04c7               L706:
1961                     ; 406         TIM2->CR1 &= (uint8_t)(~TIM2_CR1_UDIS);
1963  04c7 72135300      	bres	21248,#1
1964  04cb               L116:
1965                     ; 408 }
1968  04cb 84            	pop	a
1969  04cc 81            	ret
2028                     ; 418 void TIM2_UpdateRequestConfig(TIM2_UpdateSource_TypeDef TIM2_UpdateSource)
2028                     ; 419 {
2029                     	switch	.text
2030  04cd               _TIM2_UpdateRequestConfig:
2032  04cd 88            	push	a
2033       00000000      OFST:	set	0
2036                     ; 421     assert_param(IS_TIM2_UPDATE_SOURCE_OK(TIM2_UpdateSource));
2038  04ce 4d            	tnz	a
...
2054  04e8               L632:
2055                     ; 424     if (TIM2_UpdateSource != TIM2_UPDATESOURCE_GLOBAL)
2057  04e8 0d01          	tnz	(OFST+1,sp)
2058  04ea 2706          	jreq	L146
2059                     ; 426         TIM2->CR1 |= (uint8_t)TIM2_CR1_URS;
2061  04ec 72145300      	bset	21248,#2
2063  04f0 2004          	jra	L346
2064  04f2               L146:
2065                     ; 430         TIM2->CR1 &= (uint8_t)(~TIM2_CR1_URS);
2067  04f2 72155300      	bres	21248,#2
2068  04f6               L346:
2069                     ; 432 }
2072  04f6 84            	pop	a
2073  04f7 81            	ret
2131                     ; 443 void TIM2_SelectOnePulseMode(TIM2_OPMode_TypeDef TIM2_OPMode)
2131                     ; 444 {
2132                     	switch	.text
2133  04f8               _TIM2_SelectOnePulseMode:
2135  04f8 88            	push	a
2136       00000000      OFST:	set	0
2139                     ; 446     assert_param(IS_TIM2_OPM_MODE_OK(TIM2_OPMode));
...
2157  0513               L642:
2158                     ; 449     if (TIM2_OPMode != TIM2_OPMODE_REPETITIVE)
2160  0513 0d01          	tnz	(OFST+1,sp)
2161  0515 2706          	jreq	L376
2162                     ; 451         TIM2->CR1 |= (uint8_t)TIM2_CR1_OPM;
2164  0517 72165300      	bset	21248,#3
2166  051b 2004          	jra	L576
2167  051d               L376:
2168                     ; 455         TIM2->CR1 &= (uint8_t)(~TIM2_CR1_OPM);
2170  051d 72175300      	bres	21248,#3
2171  0521               L576:
2172                     ; 458 }
2175  0521 84            	pop	a
2176  0522 81            	ret
2245                     ; 489 void TIM2_PrescalerConfig(TIM2_Prescaler_TypeDef Prescaler,
2245                     ; 490                           TIM2_PSCReloadMode_TypeDef TIM2_PSCReloadMode)
2245                     ; 491 {
2246                     	switch	.text
2247  0523               _TIM2_PrescalerConfig:
2249  0523 89            	pushw	x
2250       00000000      OFST:	set	0
2253                     ; 493     assert_param(IS_TIM2_PRESCALER_RELOAD_OK(TIM2_PSCReloadMode));
...
2273  0540               L652:
2274                     ; 494     assert_param(IS_TIM2_PRESCALER_OK(Prescaler));
...
2335  05b1               L462:
2336                     ; 497     TIM2->PSCR = (uint8_t)Prescaler;
2338  05b1 7b01          	ld	a,(OFST+1,sp)
2339  05b3 c7530c        	ld	21260,a
2340                     ; 500     TIM2->EGR = (uint8_t)TIM2_PSCReloadMode;
2342  05b6 7b02          	ld	a,(OFST+2,sp)
2343  05b8 c75304        	ld	21252,a
2344                     ; 501 }
2347  05bb 85            	popw	x
2348  05bc 81            	ret
2407                     ; 512 void TIM2_ForcedOC1Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2407                     ; 513 {
2408                     	switch	.text
2409  05bd               _TIM2_ForcedOC1Config:
2411  05bd 88            	push	a
2412       00000000      OFST:	set	0
2415                     ; 515     assert_param(IS_TIM2_FORCED_ACTION_OK(TIM2_ForcedAction));
...
2433  05d9               L472:
2434                     ; 518     TIM2->CCMR1  =  (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~TIM2_CCMR_OCM))  
2434                     ; 519                               | (uint8_t)TIM2_ForcedAction);
2436  05d9 c65305        	ld	a,21253
2437  05dc a48f          	and	a,#143
2438  05de 1a01          	or	a,(OFST+1,sp)
2439  05e0 c75305        	ld	21253,a
2440                     ; 520 }
2443  05e3 84            	pop	a
2444  05e4 81            	ret
2481                     ; 531 void TIM2_ForcedOC2Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2481                     ; 532 {
2482                     	switch	.text
2483  05e5               _TIM2_ForcedOC2Config:
2485  05e5 88            	push	a
2486       00000000      OFST:	set	0
2489                     ; 534     assert_param(IS_TIM2_FORCED_ACTION_OK(TIM2_ForcedAction));
...
2507  0601               L403:
2508                     ; 537     TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~TIM2_CCMR_OCM))  
2508                     ; 538                             | (uint8_t)TIM2_ForcedAction);
2510  0601 c65306        	ld	a,21254
2511  0604 a48f          	and	a,#143
2512  0606 1a01          	or	a,(OFST+1,sp)
2513  0608 c75306        	ld	21254,a
2514                     ; 539 }
2517  060b 84            	pop	a
2518  060c 81            	ret
2555                     ; 550 void TIM2_ForcedOC3Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2555                     ; 551 {
2556                     	switch	.text
2557  060d               _TIM2_ForcedOC3Config:
2559  060d 88            	push	a
2560       00000000      OFST:	set	0
2563                     ; 553     assert_param(IS_TIM2_FORCED_ACTION_OK(TIM2_ForcedAction));
...
2581  0629               L413:
2582                     ; 556     TIM2->CCMR3  =  (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~TIM2_CCMR_OCM))
2582                     ; 557                               | (uint8_t)TIM2_ForcedAction);
2584  0629 c65307        	ld	a,21255
2585  062c a48f          	and	a,#143
2586  062e 1a01          	or	a,(OFST+1,sp)
2587  0630 c75307        	ld	21255,a
2588                     ; 558 }
2591  0633 84            	pop	a
2592  0634 81            	ret
2629                     ; 567 void TIM2_ARRPreloadConfig(FunctionalState NewState)
2629                     ; 568 {
2630                     	switch	.text
2631  0635               _TIM2_ARRPreloadConfig:
2633  0635 88            	push	a
2634       00000000      OFST:	set	0
2637                     ; 570     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2639  0636 4d            	tnz	a
...
2655  0650               L423:
2656                     ; 573     if (NewState != DISABLE)
2658  0650 0d01          	tnz	(OFST+1,sp)
2659  0652 2706          	jreq	L1301
2660                     ; 575         TIM2->CR1 |= (uint8_t)TIM2_CR1_ARPE;
2662  0654 721e5300      	bset	21248,#7
2664  0658 2004          	jra	L3301
2665  065a               L1301:
2666                     ; 579         TIM2->CR1 &= (uint8_t)(~TIM2_CR1_ARPE);
2668  065a 721f5300      	bres	21248,#7
2669  065e               L3301:
2670                     ; 581 }
2673  065e 84            	pop	a
2674  065f 81            	ret
2711                     ; 590 void TIM2_OC1PreloadConfig(FunctionalState NewState)
2711                     ; 591 {
2712                     	switch	.text
2713  0660               _TIM2_OC1PreloadConfig:
2715  0660 88            	push	a
2716       00000000      OFST:	set	0
2719                     ; 593     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2721  0661 4d            	tnz	a
...
2737  067b               L433:
2738                     ; 596     if (NewState != DISABLE)
2740  067b 0d01          	tnz	(OFST+1,sp)
2741  067d 2706          	jreq	L3501
2742                     ; 598         TIM2->CCMR1 |= (uint8_t)TIM2_CCMR_OCxPE;
2744  067f 72165305      	bset	21253,#3
2746  0683 2004          	jra	L5501
2747  0685               L3501:
2748                     ; 602         TIM2->CCMR1 &= (uint8_t)(~TIM2_CCMR_OCxPE);
2750  0685 72175305      	bres	21253,#3
2751  0689               L5501:
2752                     ; 604 }
2755  0689 84            	pop	a
2756  068a 81            	ret
2793                     ; 613 void TIM2_OC2PreloadConfig(FunctionalState NewState)
2793                     ; 614 {
2794                     	switch	.text
2795  068b               _TIM2_OC2PreloadConfig:
2797  068b 88            	push	a
2798       00000000      OFST:	set	0
2801                     ; 616     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2803  068c 4d            	tnz	a
...
2819  06a6               L443:
2820                     ; 619     if (NewState != DISABLE)
2822  06a6 0d01          	tnz	(OFST+1,sp)
2823  06a8 2706          	jreq	L5701
2824                     ; 621         TIM2->CCMR2 |= (uint8_t)TIM2_CCMR_OCxPE;
2826  06aa 72165306      	bset	21254,#3
2828  06ae 2004          	jra	L7701
2829  06b0               L5701:
2830                     ; 625         TIM2->CCMR2 &= (uint8_t)(~TIM2_CCMR_OCxPE);
2832  06b0 72175306      	bres	21254,#3
2833  06b4               L7701:
2834                     ; 627 }
2837  06b4 84            	pop	a
2838  06b5 81            	ret
2875                     ; 636 void TIM2_OC3PreloadConfig(FunctionalState NewState)
2875                     ; 637 {
2876                     	switch	.text
2877  06b6               _TIM2_OC3PreloadConfig:
2879  06b6 88            	push	a
2880       00000000      OFST:	set	0
2883                     ; 639     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2885  06b7 4d            	tnz	a
...
2901  06d1               L453:
2902                     ; 642     if (NewState != DISABLE)
2904  06d1 0d01          	tnz	(OFST+1,sp)
2905  06d3 2706          	jreq	L7111
2906                     ; 644         TIM2->CCMR3 |= (uint8_t)TIM2_CCMR_OCxPE;
2908  06d5 72165307      	bset	21255,#3
2910  06d9 2004          	jra	L1211
2911  06db               L7111:
2912                     ; 648         TIM2->CCMR3 &= (uint8_t)(~TIM2_CCMR_OCxPE);
2914  06db 72175307      	bres	21255,#3
2915  06df               L1211:
2916                     ; 650 }
2919  06df 84            	pop	a
2920  06e0 81            	ret
2994                     ; 663 void TIM2_GenerateEvent(TIM2_EventSource_TypeDef TIM2_EventSource)
2994                     ; 664 {
2995                     	switch	.text
2996  06e1               _TIM2_GenerateEvent:
2998  06e1 88            	push	a
2999       00000000      OFST:	set	0
3002                     ; 666     assert_param(IS_TIM2_EVENT_SOURCE_OK(TIM2_EventSource));
3004  06e2 4d            	tnz	a
3005  06e3 2703          	jreq	L063
3006  06e5 4f            	clr	a
3007  06e6 2010          	jra	L263
3008  06e8               L063:
3009  06e8 ae029a        	ldw	x,#666
...
3017  06f8               L263:
3018                     ; 669     TIM2->EGR = (uint8_t)TIM2_EventSource;
3020  06f8 7b01          	ld	a,(OFST+1,sp)
3021  06fa c75304        	ld	21252,a
3022                     ; 670 }
3025  06fd 84            	pop	a
3026  06fe 81            	ret
3063                     ; 681 void TIM2_OC1PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
3063                     ; 682 {
3064                     	switch	.text
3065  06ff               _TIM2_OC1PolarityConfig:
3067  06ff 88            	push	a
3068       00000000      OFST:	set	0
3071                     ; 684     assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
3073  0700 4d            	tnz	a
...
3089  071a               L273:
3090                     ; 687     if (TIM2_OCPolarity != TIM2_OCPOLARITY_HIGH)
3092  071a 0d01          	tnz	(OFST+1,sp)
3093  071c 2706          	jreq	L3711
3094                     ; 689         TIM2->CCER1 |= (uint8_t)TIM2_CCER1_CC1P;
3096  071e 72125308      	bset	21256,#1
3098  0722 2004          	jra	L5711
3099  0724               L3711:
3100                     ; 693         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1P);
3102  0724 72135308      	bres	21256,#1
3103  0728               L5711:
3104                     ; 695 }
3107  0728 84            	pop	a
3108  0729 81            	ret
3145                     ; 706 void TIM2_OC2PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
3145                     ; 707 {
3146                     	switch	.text
3147  072a               _TIM2_OC2PolarityConfig:
3149  072a 88            	push	a
3150       00000000      OFST:	set	0
3153                     ; 709     assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
3155  072b 4d            	tnz	a
...
3171  0745               L204:
3172                     ; 712     if (TIM2_OCPolarity != TIM2_OCPOLARITY_HIGH)
3174  0745 0d01          	tnz	(OFST+1,sp)
3175  0747 2706          	jreq	L5121
3176                     ; 714         TIM2->CCER1 |= TIM2_CCER1_CC2P;
3178  0749 721a5308      	bset	21256,#5
3180  074d 2004          	jra	L7121
3181  074f               L5121:
3182                     ; 718         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2P);
3184  074f 721b5308      	bres	21256,#5
3185  0753               L7121:
3186                     ; 720 }
3189  0753 84            	pop	a
3190  0754 81            	ret
3227                     ; 731 void TIM2_OC3PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
3227                     ; 732 {
3228                     	switch	.text
3229  0755               _TIM2_OC3PolarityConfig:
3231  0755 88            	push	a
3232       00000000      OFST:	set	0
3235                     ; 734     assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
3237  0756 4d            	tnz	a
...
3253  0770               L214:
3254                     ; 737     if (TIM2_OCPolarity != TIM2_OCPOLARITY_HIGH)
3256  0770 0d01          	tnz	(OFST+1,sp)
3257  0772 2706          	jreq	L7321
3258                     ; 739         TIM2->CCER2 |= (uint8_t)TIM2_CCER2_CC3P;
3260  0774 72125309      	bset	21257,#1
3262  0778 2004          	jra	L1421
3263  077a               L7321:
3264                     ; 743         TIM2->CCER2 &= (uint8_t)(~TIM2_CCER2_CC3P);
3266  077a 72135309      	bres	21257,#1
3267  077e               L1421:
3268                     ; 745 }
3271  077e 84            	pop	a
3272  077f 81            	ret
3318                     ; 759 void TIM2_CCxCmd(TIM2_Channel_TypeDef TIM2_Channel, FunctionalState NewState)
3318                     ; 760 {
3319                     	switch	.text
3320  0780               _TIM2_CCxCmd:
3322  0780 89            	pushw	x
3323       00000000      OFST:	set	0
3326                     ; 762     assert_param(IS_TIM2_CHANNEL_OK(TIM2_Channel));
...
3349  07a2               L224:
3350                     ; 763     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
3369  07bf               L034:
3370                     ; 765     if (TIM2_Channel == TIM2_CHANNEL_1)
3372  07bf 0d01          	tnz	(OFST+1,sp)
3373  07c1 2610          	jrne	L5621
3374                     ; 768         if (NewState != DISABLE)
3376  07c3 0d02          	tnz	(OFST+2,sp)
3377  07c5 2706          	jreq	L7621
3378                     ; 770             TIM2->CCER1 |= (uint8_t)TIM2_CCER1_CC1E;
3380  07c7 72105308      	bset	21256,#0
3382  07cb 202a          	jra	L3721
3383  07cd               L7621:
3384                     ; 774             TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1E);
3386  07cd 72115308      	bres	21256,#0
3387  07d1 2024          	jra	L3721
3388  07d3               L5621:
3389                     ; 778     else if (TIM2_Channel == TIM2_CHANNEL_2)
3391  07d3 7b01          	ld	a,(OFST+1,sp)
3392  07d5 a101          	cp	a,#1
3393  07d7 2610          	jrne	L5721
3394                     ; 781         if (NewState != DISABLE)
3396  07d9 0d02          	tnz	(OFST+2,sp)
3397  07db 2706          	jreq	L7721
3398                     ; 783             TIM2->CCER1 |= (uint8_t)TIM2_CCER1_CC2E;
3400  07dd 72185308      	bset	21256,#4
3402  07e1 2014          	jra	L3721
3403  07e3               L7721:
3404                     ; 787             TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2E);
3406  07e3 72195308      	bres	21256,#4
3407  07e7 200e          	jra	L3721
3408  07e9               L5721:
3409                     ; 793         if (NewState != DISABLE)
3411  07e9 0d02          	tnz	(OFST+2,sp)
3412  07eb 2706          	jreq	L5031
3413                     ; 795             TIM2->CCER2 |= (uint8_t)TIM2_CCER2_CC3E;
3415  07ed 72105309      	bset	21257,#0
3417  07f1 2004          	jra	L3721
3418  07f3               L5031:
3419                     ; 799             TIM2->CCER2 &= (uint8_t)(~TIM2_CCER2_CC3E);
3421  07f3 72115309      	bres	21257,#0
3422  07f7               L3721:
3423                     ; 802 }
3426  07f7 85            	popw	x
3427  07f8 81            	ret
3473                     ; 824 void TIM2_SelectOCxM(TIM2_Channel_TypeDef TIM2_Channel, TIM2_OCMode_TypeDef TIM2_OCMode)
3473                     ; 825 {
3474                     	switch	.text
3475  07f9               _TIM2_SelectOCxM:
3477  07f9 89            	pushw	x
3478       00000000      OFST:	set	0
3481                     ; 827     assert_param(IS_TIM2_CHANNEL_OK(TIM2_Channel));
...
3504  081b               L044:
3505                     ; 828     assert_param(IS_TIM2_OCM_OK(TIM2_OCMode));
...
3542  085c               L644:
3543                     ; 830     if (TIM2_Channel == TIM2_CHANNEL_1)
3545  085c 0d01          	tnz	(OFST+1,sp)
3546  085e 2610          	jrne	L3331
3547                     ; 833         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1E);
3549  0860 72115308      	bres	21256,#0
3550                     ; 836         TIM2->CCMR1 = (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~TIM2_CCMR_OCM))
3550                     ; 837                                | (uint8_t)TIM2_OCMode);
3552  0864 c65305        	ld	a,21253
3553  0867 a48f          	and	a,#143
3554  0869 1a02          	or	a,(OFST+2,sp)
3555  086b c75305        	ld	21253,a
3557  086e 2024          	jra	L5331
3558  0870               L3331:
3559                     ; 839     else if (TIM2_Channel == TIM2_CHANNEL_2)
3561  0870 7b01          	ld	a,(OFST+1,sp)
3562  0872 a101          	cp	a,#1
3563  0874 2610          	jrne	L7331
3564                     ; 842         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2E);
3566  0876 72195308      	bres	21256,#4
3567                     ; 845         TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~TIM2_CCMR_OCM))
3567                     ; 846                                 | (uint8_t)TIM2_OCMode);
3569  087a c65306        	ld	a,21254
3570  087d a48f          	and	a,#143
3571  087f 1a02          	or	a,(OFST+2,sp)
3572  0881 c75306        	ld	21254,a
3574  0884 200e          	jra	L5331
3575  0886               L7331:
3576                     ; 851         TIM2->CCER2 &= (uint8_t)(~TIM2_CCER2_CC3E);
3578  0886 72115309      	bres	21257,#0
3579                     ; 854         TIM2->CCMR3 = (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~TIM2_CCMR_OCM))
3579                     ; 855                                 | (uint8_t)TIM2_OCMode);
3581  088a c65307        	ld	a,21255
3582  088d a48f          	and	a,#143
3583  088f 1a02          	or	a,(OFST+2,sp)
3584  0891 c75307        	ld	21255,a
3585  0894               L5331:
3586                     ; 857 }
3589  0894 85            	popw	x
3590  0895 81            	ret
3624                     ; 866 void TIM2_SetCounter(uint16_t Counter)
3624                     ; 867 {
3625                     	switch	.text
3626  0896               _TIM2_SetCounter:
3630                     ; 869     TIM2->CNTRH = (uint8_t)(Counter >> 8);
3632  0896 9e            	ld	a,xh
3633  0897 c7530a        	ld	21258,a
3634                     ; 870     TIM2->CNTRL = (uint8_t)(Counter);
3636  089a 9f            	ld	a,xl
3637  089b c7530b        	ld	21259,a
3638                     ; 872 }
3641  089e 81            	ret
3675                     ; 881 void TIM2_SetAutoreload(uint16_t Autoreload)
3675                     ; 882 {
3676                     	switch	.text
3677  089f               _TIM2_SetAutoreload:
3681                     ; 885     TIM2->ARRH = (uint8_t)(Autoreload >> 8);
3683  089f 9e            	ld	a,xh
3684  08a0 c7530d        	ld	21261,a
3685                     ; 886     TIM2->ARRL = (uint8_t)(Autoreload);
3687  08a3 9f            	ld	a,xl
3688  08a4 c7530e        	ld	21262,a
3689                     ; 888 }
3692  08a7 81            	ret
3726                     ; 897 void TIM2_SetCompare1(uint16_t Compare1)
3726                     ; 898 {
3727                     	switch	.text
3728  08a8               _TIM2_SetCompare1:
3732                     ; 900     TIM2->CCR1H = (uint8_t)(Compare1 >> 8);
3734  08a8 9e            	ld	a,xh
3735  08a9 c7530f        	ld	21263,a
3736                     ; 901     TIM2->CCR1L = (uint8_t)(Compare1);
3738  08ac 9f            	ld	a,xl
3739  08ad c75310        	ld	21264,a
3740                     ; 903 }
3743  08b0 81            	ret
3777                     ; 912 void TIM2_SetCompare2(uint16_t Compare2)
3777                     ; 913 {
3778                     	switch	.text
3779  08b1               _TIM2_SetCompare2:
3783                     ; 915     TIM2->CCR2H = (uint8_t)(Compare2 >> 8);
3785  08b1 9e            	ld	a,xh
3786  08b2 c75311        	ld	21265,a
3787                     ; 916     TIM2->CCR2L = (uint8_t)(Compare2);
3789  08b5 9f            	ld	a,xl
3790  08b6 c75312        	ld	21266,a
3791                     ; 918 }
3794  08b9 81            	ret
3828                     ; 927 void TIM2_SetCompare3(uint16_t Compare3)
3828                     ; 928 {
3829                     	switch	.text
3830  08ba               _TIM2_SetCompare3:
3834                     ; 930     TIM2->CCR3H = (uint8_t)(Compare3 >> 8);
3836  08ba 9e            	ld	a,xh
3837  08bb c75313        	ld	21267,a
3838                     ; 931     TIM2->CCR3L = (uint8_t)(Compare3);
3840  08be 9f            	ld	a,xl
3841  08bf c75314        	ld	21268,a
3842                     ; 933 }
3845  08c2 81            	ret
3882                     ; 946 void TIM2_SetIC1Prescaler(TIM2_ICPSC_TypeDef TIM2_IC1Prescaler)
3882                     ; 947 {
3883                     	switch	.text
3884  08c3               _TIM2_SetIC1Prescaler:
3886  08c3 88            	push	a
3887       00000000      OFST:	set	0
3890                     ; 949     assert_param(IS_TIM2_IC_PRESCALER_OK(TIM2_IC1Prescaler));
3892  08c4 4d            	tnz	a
...
3912  08e6               L074:
3913                     ; 952     TIM2->CCMR1 = (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~TIM2_CCMR_ICxPSC))
3913                     ; 953                             | (uint8_t)TIM2_IC1Prescaler);
3915  08e6 c65305        	ld	a,21253
3916  08e9 a4f3          	and	a,#243
3917  08eb 1a01          	or	a,(OFST+1,sp)
3918  08ed c75305        	ld	21253,a
3919                     ; 954 }
3922  08f0 84            	pop	a
3923  08f1 81            	ret
3960                     ; 966 void TIM2_SetIC2Prescaler(TIM2_ICPSC_TypeDef TIM2_IC2Prescaler)
3960                     ; 967 {
3961                     	switch	.text
3962  08f2               _TIM2_SetIC2Prescaler:
3964  08f2 88            	push	a
3965       00000000      OFST:	set	0
3968                     ; 969     assert_param(IS_TIM2_IC_PRESCALER_OK(TIM2_IC2Prescaler));
3970  08f3 4d            	tnz	a
...
3990  0915               L005:
3991                     ; 972     TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~TIM2_CCMR_ICxPSC))
3991                     ; 973                             | (uint8_t)TIM2_IC2Prescaler);
3993  0915 c65306        	ld	a,21254
3994  0918 a4f3          	and	a,#243
3995  091a 1a01          	or	a,(OFST+1,sp)
3996  091c c75306        	ld	21254,a
3997                     ; 974 }
4000  091f 84            	pop	a
4001  0920 81            	ret
4038                     ; 986 void TIM2_SetIC3Prescaler(TIM2_ICPSC_TypeDef TIM2_IC3Prescaler)
4038                     ; 987 {
4039                     	switch	.text
4040  0921               _TIM2_SetIC3Prescaler:
4042  0921 88            	push	a
4043       00000000      OFST:	set	0
4046                     ; 990     assert_param(IS_TIM2_IC_PRESCALER_OK(TIM2_IC3Prescaler));
4048  0922 4d            	tnz	a
...
4068  0944               L015:
4069                     ; 992     TIM2->CCMR3 = (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~TIM2_CCMR_ICxPSC))
4069                     ; 993                             | (uint8_t)TIM2_IC3Prescaler);
4071  0944 c65307        	ld	a,21255
4072  0947 a4f3          	and	a,#243
4073  0949 1a01          	or	a,(OFST+1,sp)
4074  094b c75307        	ld	21255,a
4075                     ; 994 }
4078  094e 84            	pop	a
4079  094f 81            	ret
4131                     ; 1001 uint16_t TIM2_GetCapture1(void)
4131                     ; 1002 {
4132                     	switch	.text
4133  0950               _TIM2_GetCapture1:
4135  0950 5204          	subw	sp,#4
4136       00000004      OFST:	set	4
4139                     ; 1004     uint16_t tmpccr1 = 0;
4141                     ; 1005     uint8_t tmpccr1l=0, tmpccr1h=0;
4145                     ; 1007     tmpccr1h = TIM2->CCR1H;
4147  0952 c6530f        	ld	a,21263
4148  0955 6b02          	ld	(OFST-2,sp),a
4149                     ; 1008     tmpccr1l = TIM2->CCR1L;
4151  0957 c65310        	ld	a,21264
4152  095a 6b01          	ld	(OFST-3,sp),a
4153                     ; 1010     tmpccr1 = (uint16_t)(tmpccr1l);
4155  095c 7b01          	ld	a,(OFST-3,sp)
4156  095e 5f            	clrw	x
4157  095f 97            	ld	xl,a
4158  0960 1f03          	ldw	(OFST-1,sp),x
4159                     ; 1011     tmpccr1 |= (uint16_t)((uint16_t)tmpccr1h << 8);
...
4172                     ; 1013     return (uint16_t)tmpccr1;
4174  0971 1e03          	ldw	x,(OFST-1,sp)
4177  0973 5b04          	addw	sp,#4
4178  0975 81            	ret
4230                     ; 1021 uint16_t TIM2_GetCapture2(void)
4230                     ; 1022 {
4231                     	switch	.text
4232  0976               _TIM2_GetCapture2:
4234  0976 5204          	subw	sp,#4
4235       00000004      OFST:	set	4
4238                     ; 1024     uint16_t tmpccr2 = 0;
4240                     ; 1025     uint8_t tmpccr2l=0, tmpccr2h=0;
4244                     ; 1027     tmpccr2h = TIM2->CCR2H;
4246  0978 c65311        	ld	a,21265
4247  097b 6b02          	ld	(OFST-2,sp),a
4248                     ; 1028     tmpccr2l = TIM2->CCR2L;
4250  097d c65312        	ld	a,21266
4251  0980 6b01          	ld	(OFST-3,sp),a
4252                     ; 1030     tmpccr2 = (uint16_t)(tmpccr2l);
4254  0982 7b01          	ld	a,(OFST-3,sp)
4255  0984 5f            	clrw	x
4256  0985 97            	ld	xl,a
4257  0986 1f03          	ldw	(OFST-1,sp),x
4258                     ; 1031     tmpccr2 |= (uint16_t)((uint16_t)tmpccr2h << 8);
...
4271                     ; 1033     return (uint16_t)tmpccr2;
4273  0997 1e03          	ldw	x,(OFST-1,sp)
4276  0999 5b04          	addw	sp,#4
4277  099b 81            	ret
4329                     ; 1041 uint16_t TIM2_GetCapture3(void)
4329                     ; 1042 {
4330                     	switch	.text
4331  099c               _TIM2_GetCapture3:
4333  099c 5204          	subw	sp,#4
4334       00000004      OFST:	set	4
4337                     ; 1044     uint16_t tmpccr3 = 0;
4339                     ; 1045     uint8_t tmpccr3l=0, tmpccr3h=0;
4343                     ; 1047     tmpccr3h = TIM2->CCR3H;
4345  099e c65313        	ld	a,21267
4346  09a1 6b02          	ld	(OFST-2,sp),a
4347                     ; 1048     tmpccr3l = TIM2->CCR3L;
4349  09a3 c65314        	ld	a,21268
4350  09a6 6b01          	ld	(OFST-3,sp),a
4351                     ; 1050     tmpccr3 = (uint16_t)(tmpccr3l);
4353  09a8 7b01          	ld	a,(OFST-3,sp)
4354  09aa 5f            	clrw	x
4355  09ab 97            	ld	xl,a
4356  09ac 1f03          	ldw	(OFST-1,sp),x
4357                     ; 1051     tmpccr3 |= (uint16_t)((uint16_t)tmpccr3h << 8);
...
4370                     ; 1053     return (uint16_t)tmpccr3;
4372  09bd 1e03          	ldw	x,(OFST-1,sp)
4375  09bf 5b04          	addw	sp,#4
4376  09c1 81            	ret
4410                     ; 1061 uint16_t TIM2_GetCounter(void)
4410                     ; 1062 {
4411                     	switch	.text
4412  09c2               _TIM2_GetCounter:
4414  09c2 89            	pushw	x
4415       00000002      OFST:	set	2
4418                     ; 1063      uint16_t tmpcntr = 0;
4420                     ; 1065     tmpcntr =  ((uint16_t)TIM2->CNTRH << 8);
4422  09c3 c6530a        	ld	a,21258
4423  09c6 5f            	clrw	x
4424  09c7 97            	ld	xl,a
4425  09c8 4f            	clr	a
4426  09c9 02            	rlwa	x,a
4427  09ca 1f01          	ldw	(OFST-1,sp),x
4428                     ; 1067     return (uint16_t)( tmpcntr| (uint16_t)(TIM2->CNTRL));
4430  09cc c6530b        	ld	a,21259
4431  09cf 5f            	clrw	x
...
4441  09da 81            	ret
4465                     ; 1076 TIM2_Prescaler_TypeDef TIM2_GetPrescaler(void)
4465                     ; 1077 {
4466                     	switch	.text
4467  09db               _TIM2_GetPrescaler:
4471                     ; 1079     return (TIM2_Prescaler_TypeDef)(TIM2->PSCR);
4473  09db c6530c        	ld	a,21260
4476  09de 81            	ret
4616                     ; 1096 FlagStatus TIM2_GetFlagStatus(TIM2_FLAG_TypeDef TIM2_FLAG)
4616                     ; 1097 {
4617                     	switch	.text
...
4625                     ; 1098     FlagStatus bitstatus = RESET;
4627                     ; 1099     uint8_t tim2_flag_l = 0, tim2_flag_h = 0;
4631                     ; 1102     assert_param(IS_TIM2_GET_FLAG_OK(TIM2_FLAG));
...
4758  0a5c               L045:
4759                     ; 1138     TIM2->SR1 = (uint8_t)(~((uint8_t)(TIM2_FLAG)));
4761  0a5c 7b02          	ld	a,(OFST+2,sp)
4762  0a5e 43            	cpl	a
4763  0a5f c75302        	ld	21250,a
4764                     ; 1139     TIM2->SR2 = (uint8_t)(~((uint8_t)((uint8_t)TIM2_FLAG >> 8)));
4766  0a62 35ff5303      	mov	21251,#255
4767                     ; 1140 }
4770  0a66 85            	popw	x
4771  0a67 81            	ret
4836                     ; 1154 ITStatus TIM2_GetITStatus(TIM2_IT_TypeDef TIM2_IT)
4836                     ; 1155 {
4837                     	switch	.text
...
4845                     ; 1156     ITStatus bitstatus = RESET;
4847                     ; 1157     uint8_t TIM2_itStatus = 0, TIM2_itEnable = 0;
4851                     ; 1160     assert_param(IS_TIM2_GET_IT_OK(TIM2_IT));
...
4970  0acb               L655:
4971                     ; 1194     TIM2->SR1 = (uint8_t)(~TIM2_IT);
4973  0acb 7b01          	ld	a,(OFST+1,sp)
4974  0acd 43            	cpl	a
4975  0ace c75302        	ld	21250,a
4976                     ; 1195 }
4979  0ad1 84            	pop	a
4980  0ad2 81            	ret
5032                     ; 1214 static void TI1_Config(uint8_t TIM2_ICPolarity,
5032                     ; 1215                        uint8_t TIM2_ICSelection,
5032                     ; 1216                        uint8_t TIM2_ICFilter)
5032                     ; 1217 {
5033                     	switch	.text
...
5041                     ; 1219     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1E);
5043  0ad5 72115308      	bres	21256,#0
5044                     ; 1222     TIM2->CCMR1  = (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~(uint8_t)( TIM2_CCMR_CCxS | TIM2_CCMR_ICxF )))
5044                     ; 1223                              | (uint8_t)(((TIM2_ICSelection)) | ((uint8_t)( TIM2_ICFilter << 4))));
...
5053  0ae4 c65305        	ld	a,21253
5054  0ae7 a40c          	and	a,#12
5055  0ae9 1a01          	or	a,(OFST+0,sp)
5056  0aeb c75305        	ld	21253,a
5057                     ; 1226     if (TIM2_ICPolarity != TIM2_ICPOLARITY_RISING)
5059  0aee 0d02          	tnz	(OFST+1,sp)
5060  0af0 2706          	jreq	L3602
5061                     ; 1228         TIM2->CCER1 |= TIM2_CCER1_CC1P;
5063  0af2 72125308      	bset	21256,#1
5065  0af6 2004          	jra	L5602
5066  0af8               L3602:
5067                     ; 1232         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1P);
5069  0af8 72135308      	bres	21256,#1
5070  0afc               L5602:
5071                     ; 1235     TIM2->CCER1 |= TIM2_CCER1_CC1E;
5073  0afc 72105308      	bset	21256,#0
5074                     ; 1236 }
5077  0b00 5b03          	addw	sp,#3
5078  0b02 81            	ret
5130                     ; 1255 static void TI2_Config(uint8_t TIM2_ICPolarity,
5130                     ; 1256                        uint8_t TIM2_ICSelection,
5130                     ; 1257                        uint8_t TIM2_ICFilter)
5130                     ; 1258 {
5131                     	switch	.text
...
5139                     ; 1260     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2E);
5141  0b05 72195308      	bres	21256,#4
5142                     ; 1263     TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~(uint8_t)( TIM2_CCMR_CCxS | TIM2_CCMR_ICxF ))) 
5142                     ; 1264                             | (uint8_t)(( (TIM2_ICSelection)) | ((uint8_t)( TIM2_ICFilter << 4))));
...
5151  0b14 c65306        	ld	a,21254
5152  0b17 a40c          	and	a,#12
5153  0b19 1a01          	or	a,(OFST+0,sp)
5154  0b1b c75306        	ld	21254,a
5155                     ; 1268     if (TIM2_ICPolarity != TIM2_ICPOLARITY_RISING)
5157  0b1e 0d02          	tnz	(OFST+1,sp)
5158  0b20 2706          	jreq	L5112
5159                     ; 1270         TIM2->CCER1 |= TIM2_CCER1_CC2P;
5161  0b22 721a5308      	bset	21256,#5
5163  0b26 2004          	jra	L7112
5164  0b28               L5112:
5165                     ; 1274         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2P);
5167  0b28 721b5308      	bres	21256,#5
5168  0b2c               L7112:
5169                     ; 1278     TIM2->CCER1 |= TIM2_CCER1_CC2E;
5171  0b2c 72185308      	bset	21256,#4
5172                     ; 1280 }
5175  0b30 5b03          	addw	sp,#3
5176  0b32 81            	ret
5228                     ; 1296 static void TI3_Config(uint8_t TIM2_ICPolarity, uint8_t TIM2_ICSelection,
5228                     ; 1297                        uint8_t TIM2_ICFilter)
5228                     ; 1298 {
5229                     	switch	.text
...
5237                     ; 1300     TIM2->CCER2 &=  (uint8_t)(~TIM2_CCER2_CC3E);
5239  0b35 72115309      	bres	21257,#0
5240                     ; 1303     TIM2->CCMR3 = (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~( TIM2_CCMR_CCxS | TIM2_CCMR_ICxF))) 
5240                     ; 1304                             | (uint8_t)(( (TIM2_ICSelection)) | ((uint8_t)( TIM2_ICFilter << 4))));
...
5249  0b44 c65307        	ld	a,21255
5250  0b47 a40c          	and	a,#12
5251  0b49 1a01          	or	a,(OFST+0,sp)
5252  0b4b c75307        	ld	21255,a
5253                     ; 1308     if (TIM2_ICPolarity != TIM2_ICPOLARITY_RISING)
5255  0b4e 0d02          	tnz	(OFST+1,sp)
5256  0b50 2706          	jreq	L7412
5257                     ; 1310         TIM2->CCER2 |= TIM2_CCER2_CC3P;
5259  0b52 72125309      	bset	21257,#1
5261  0b56 2004          	jra	L1512
5262  0b58               L7412:
5263                     ; 1314         TIM2->CCER2 &= (uint8_t)(~TIM2_CCER2_CC3P);
5265  0b58 72135309      	bres	21257,#1
5266  0b5c               L1512:
5267                     ; 1317     TIM2->CCER2 |= TIM2_CCER2_CC3E;
5269  0b5c 72105309      	bset	21257,#0
5270                     ; 1318 }
...
5332  0000               L702:
5333  0000 2e2e5c6c6962  	dc.b	"..\lib\src\stm8s_t"
5334  0012 696d322e6300  	dc.b	"im2.c",0
5354                     	end
