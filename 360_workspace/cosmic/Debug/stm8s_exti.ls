 ...
 450  00fe 84            	pop	a
 451  00ff 81            	ret
 498                     ; 121 EXTI_Sensitivity_TypeDef EXTI_GetExtIntSensitivity(EXTI_Port_TypeDef Port)
 498                     ; 122 {
 499                     	switch	.text
 ...
 507                     ; 123     uint8_t value = 0;
 509  0102 0f01          	clr	(OFST+0,sp)
 510                     ; 126     assert_param(IS_EXTI_PORT_OK(Port));
 512  0104 4d            	tnz	a
 ...
 551  013d               L541:
 552                     ; 130     case EXTI_PORT_GPIOA:
 552                     ; 131         value = (uint8_t)(EXTI->CR1 & EXTI_CR1_PAIS);
 ...
 571  0151               L151:
 572                     ; 136     case EXTI_PORT_GPIOC:
 572                     ; 137         value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_PCIS) >> 4);
 ...
 582  015d               L351:
 583                     ; 139     case EXTI_PORT_GPIOD:
 583                     ; 140         value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_PDIS) >> 6);
 ...
 595  016b               L551:
 596                     ; 142     case EXTI_PORT_GPIOE:
 596                     ; 143         value = (uint8_t)(EXTI->CR2 & EXTI_CR2_PEIS);
 ...
 604                     ; 146         break;
 606  0172               L502:
 607                     ; 149     return((EXTI_Sensitivity_TypeDef)value);
 609  0172 7b01          	ld	a,(OFST+0,sp)
 612  0174 85            	popw	x
 613  0175 81            	ret
 649                     ; 157 EXTI_TLISensitivity_TypeDef EXTI_GetTLISensitivity(void)
 649                     ; 158 {
 650                     	switch	.text
 651  0176               _EXTI_GetTLISensitivity:
 653  0176 88            	push	a
 654       00000001      OFST:	set	1
 657                     ; 160     uint8_t value = 0;
 659                     ; 163     value = (uint8_t)(EXTI->CR2 & EXTI_CR2_TLIS);
 661  0177 c650a1        	ld	a,20641
 662  017a a404          	and	a,#4
 663  017c 6b01          	ld	(OFST+0,sp),a
 664                     ; 165     return((EXTI_TLISensitivity_TypeDef)value);
 ...
 690  0000               L111:
 691  0000 2e2e5c6c6962  	dc.b	"..\lib\src\stm8s_e"
 692  0012 7874692e6300  	dc.b	"xti.c",0
 712                     	end
