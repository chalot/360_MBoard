 ...
 313                     ; 78 void UART3_Init(uint32_t BaudRate, UART3_WordLength_TypeDef WordLength, 
 313                     ; 79                 UART3_StopBits_TypeDef StopBits, UART3_Parity_TypeDef Parity, 
 313                     ; 80                 UART3_Mode_TypeDef Mode)
 313                     ; 81 {
 314                     	switch	.text
 315  0023               _UART3_Init:
 317  0023 520e          	subw	sp,#14
 318       0000000e      OFST:	set	14
 321                     ; 82     uint8_t BRR2_1 = 0, BRR2_2 = 0;
 325                     ; 83     uint32_t BaudRate_Mantissa = 0, BaudRate_Mantissa100 = 0;
 329                     ; 86     assert_param(IS_UART3_WORDLENGTH_OK(WordLength));
 ...
 348  0042               L41:
 349                     ; 87     assert_param(IS_UART3_STOPBITS_OK(StopBits));
 ...
 368  005f               L22:
 369                     ; 88     assert_param(IS_UART3_PARITY_OK(Parity));
 ...
 391  0082               L03:
 392                     ; 89     assert_param(IS_UART3_BAUDRATE_OK(BaudRate));
 ...
 413  00a4               L63:
 414                     ; 90     assert_param(IS_UART3_MODE_OK((uint8_t)Mode));
 ...
 520                     ; 116     BaudRate_Mantissa100 = (((uint32_t)CLK_GetClockFreq() * 100) / (BaudRate << 4));
 ...
 546                     ; 119     BRR2_1 = (uint8_t)((uint8_t)(((BaudRate_Mantissa100 - (BaudRate_Mantissa * 100))
 546                     ; 120                         << 4) / 100) & (uint8_t)0x0F); 
 ...
 576                     ; 121     BRR2_2 = (uint8_t)((BaudRate_Mantissa >> 4) & (uint8_t)0xF0);
 ...
 856                     ; 187     uint8_t uartreg = 0, itpos = 0x00;
 860                     ; 190     assert_param(IS_UART3_CONFIG_IT_OK(UART3_IT));
 ...
 888  023d               L06:
 889                     ; 191     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 908  025a               L66:
 909                     ; 194     uartreg = (uint8_t)((uint16_t)UART3_IT >> 0x08);
 911  025a 7b03          	ld	a,(OFST+1,sp)
 912  025c 6b01          	ld	(OFST-1,sp),a
 913                     ; 197     itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)UART3_IT & (uint8_t)0x0F));
...
1019  02e0               L323:
1020                     ; 236             UART3->CR6 &= (uint8_t)(~itpos);
...
1031  02eb 81            	ret
1091                     ; 248 void UART3_LINBreakDetectionConfig(UART3_LINBreakDetectionLength_TypeDef UART3_LINBreakDetectionLength)
1091                     ; 249 {
1092                     	switch	.text
1093  02ec               _UART3_LINBreakDetectionConfig:
1095  02ec 88            	push	a
1096       00000000      OFST:	set	0
1099                     ; 251     assert_param(IS_UART3_LINBREAKDETECTIONLENGTH_OK(UART3_LINBreakDetectionLength));
1101  02ed 4d            	tnz	a
...
1117  0307               L201:
1118                     ; 253     if (UART3_LINBreakDetectionLength != UART3_LINBREAKDETECTIONLENGTH_10BITS)
1120  0307 0d01          	tnz	(OFST+1,sp)
1121  0309 2706          	jreq	L553
1122                     ; 255         UART3->CR4 |= UART3_CR4_LBDL;
1124  030b 721a5247      	bset	21063,#5
1126  030f 2004          	jra	L753
1127  0311               L553:
1128                     ; 259         UART3->CR4 &= ((uint8_t)~UART3_CR4_LBDL);
1130  0311 721b5247      	bres	21063,#5
1131  0315               L753:
1132                     ; 261 }
1135  0315 84            	pop	a
1136  0316 81            	ret
1258                     ; 273 void UART3_LINConfig(UART3_LinMode_TypeDef UART3_Mode,
1258                     ; 274                      UART3_LinAutosync_TypeDef UART3_Autosync, 
1258                     ; 275                      UART3_LinDivUp_TypeDef UART3_DivUp)
1258                     ; 276 {
1259                     	switch	.text
1260  0317               _UART3_LINConfig:
1262  0317 89            	pushw	x
1263       00000000      OFST:	set	0
1266                     ; 278     assert_param(IS_UART3_SLAVE_OK(UART3_Mode));
...
1286  0334               L211:
1287                     ; 279     assert_param(IS_UART3_AUTOSYNC_OK(UART3_Autosync));
...
1306  0351               L021:
1307                     ; 280     assert_param(IS_UART3_DIVUP_OK(UART3_DivUp));
...
1326  036e               L621:
1327                     ; 282     if (UART3_Mode != UART3_LIN_MODE_MASTER)
1329  036e 0d01          	tnz	(OFST+1,sp)
1330  0370 2706          	jreq	L734
1331                     ; 284         UART3->CR6 |=  UART3_CR6_LSLV;
1333  0372 721a5249      	bset	21065,#5
1335  0376 2004          	jra	L144
1336  0378               L734:
1337                     ; 288         UART3->CR6 &= ((uint8_t)~UART3_CR6_LSLV);
1339  0378 721b5249      	bres	21065,#5
1340  037c               L144:
1341                     ; 291     if (UART3_Autosync != UART3_LIN_AUTOSYNC_DISABLE)
1343  037c 0d02          	tnz	(OFST+2,sp)
1344  037e 2706          	jreq	L344
1345                     ; 293         UART3->CR6 |=  UART3_CR6_LASE ;
1347  0380 72185249      	bset	21065,#4
1349  0384 2004          	jra	L544
1350  0386               L344:
1351                     ; 297         UART3->CR6 &= ((uint8_t)~ UART3_CR6_LASE );
1353  0386 72195249      	bres	21065,#4
1354  038a               L544:
1355                     ; 300     if (UART3_DivUp != UART3_LIN_DIVUP_LBRR1)
1357  038a 0d05          	tnz	(OFST+5,sp)
1358  038c 2706          	jreq	L744
1359                     ; 302         UART3->CR6 |=  UART3_CR6_LDUM;
1361  038e 721e5249      	bset	21065,#7
1363  0392 2004          	jra	L154
1364  0394               L744:
1365                     ; 306         UART3->CR6 &= ((uint8_t)~ UART3_CR6_LDUM);
1367  0394 721f5249      	bres	21065,#7
1368  0398               L154:
1369                     ; 308 }
1372  0398 85            	popw	x
1373  0399 81            	ret
1409                     ; 316 void UART3_LINCmd(FunctionalState NewState)
1409                     ; 317 {
1410                     	switch	.text
1411  039a               _UART3_LINCmd:
1413  039a 88            	push	a
1414       00000000      OFST:	set	0
1417                     ; 319     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1419  039b 4d            	tnz	a
...
1435  03b5               L631:
1436                     ; 321     if (NewState != DISABLE)
1438  03b5 0d01          	tnz	(OFST+1,sp)
1439  03b7 2706          	jreq	L174
1440                     ; 324         UART3->CR3 |= UART3_CR3_LINEN;
1442  03b9 721c5246      	bset	21062,#6
1444  03bd 2004          	jra	L374
1445  03bf               L174:
1446                     ; 329         UART3->CR3 &= ((uint8_t)~UART3_CR3_LINEN);
1448  03bf 721d5246      	bres	21062,#6
1449  03c3               L374:
1450                     ; 331 }
1453  03c3 84            	pop	a
1454  03c4 81            	ret
1512                     ; 339 void UART3_WakeUpConfig(UART3_WakeUp_TypeDef UART3_WakeUp)
1512                     ; 340 {
1513                     	switch	.text
1514  03c5               _UART3_WakeUpConfig:
1516  03c5 88            	push	a
1517       00000000      OFST:	set	0
1520                     ; 342     assert_param(IS_UART3_WAKEUP_OK(UART3_WakeUp));
1522  03c6 4d            	tnz	a
...
1538  03e0               L641:
1539                     ; 344     UART3->CR1 &= ((uint8_t)~UART3_CR1_WAKE);
1541  03e0 72175244      	bres	21060,#3
1542                     ; 345     UART3->CR1 |= (uint8_t)UART3_WakeUp;
...
1550  03ec 84            	pop	a
1551  03ed 81            	ret
1588                     ; 354 void UART3_ReceiverWakeUpCmd(FunctionalState NewState)
1588                     ; 355 {
1589                     	switch	.text
1590  03ee               _UART3_ReceiverWakeUpCmd:
1592  03ee 88            	push	a
1593       00000000      OFST:	set	0
1596                     ; 357     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1598  03ef 4d            	tnz	a
...
1614  0409               L651:
1615                     ; 359     if (NewState != DISABLE)
1617  0409 0d01          	tnz	(OFST+1,sp)
1618  040b 2706          	jreq	L145
1619                     ; 362         UART3->CR2 |= UART3_CR2_RWU;
1621  040d 72125245      	bset	21061,#1
1623  0411 2004          	jra	L345
1624  0413               L145:
1625                     ; 367         UART3->CR2 &= ((uint8_t)~UART3_CR2_RWU);
1627  0413 72135245      	bres	21061,#1
1628  0417               L345:
1629                     ; 369 }
1632  0417 84            	pop	a
1633  0418 81            	ret
1656                     ; 376 uint8_t UART3_ReceiveData8(void)
1656                     ; 377 {
1657                     	switch	.text
1658  0419               _UART3_ReceiveData8:
1662                     ; 378     return ((uint8_t)UART3->DR);
1664  0419 c65241        	ld	a,21057
1667  041c 81            	ret
1701                     ; 386 uint16_t UART3_ReceiveData9(void)
1701                     ; 387 {
1702                     	switch	.text
1703  041d               _UART3_ReceiveData9:
1705  041d 89            	pushw	x
1706       00000002      OFST:	set	2
1709                     ; 388   uint16_t temp = 0;
1711                     ; 390  temp = (uint16_t)(((uint16_t)((uint16_t)UART3->CR1 & (uint16_t)UART3_CR1_R8)) << 1);
...
1720                     ; 391   return (uint16_t)((((uint16_t)UART3->DR) | temp) & ((uint16_t)0x01FF));
...
1738  043e 81            	ret
1772                     ; 399 void UART3_SendData8(uint8_t Data)
1772                     ; 400 {
1773                     	switch	.text
1774  043f               _UART3_SendData8:
1778                     ; 402     UART3->DR = Data;
1780  043f c75241        	ld	21057,a
1781                     ; 403 }
1784  0442 81            	ret
1818                     ; 410 void UART3_SendData9(uint16_t Data)
1818                     ; 411 {
1819                     	switch	.text
1820  0443               _UART3_SendData9:
1822  0443 89            	pushw	x
1823       00000000      OFST:	set	0
1826                     ; 413     UART3->CR1 &= ((uint8_t)~UART3_CR1_T8);                  
1828  0444 721d5244      	bres	21060,#6
1829                     ; 416     UART3->CR1 |= (uint8_t)(((uint8_t)(Data >> 2)) & UART3_CR1_T8); 
1831  0448 54            	srlw	x
1832  0449 54            	srlw	x
...
1952  0487 84            	pop	a
1953  0488 81            	ret
2111                     ; 454 FlagStatus UART3_GetFlagStatus(UART3_Flag_TypeDef UART3_FLAG)
2111                     ; 455 {
2112                     	switch	.text
...
2120                     ; 456     FlagStatus status = RESET;
2122                     ; 459     assert_param(IS_UART3_FLAG_OK(UART3_FLAG));
...
2160  04da               L602:
2161                     ; 462     if (UART3_FLAG == UART3_FLAG_LBDF)
2163  04da 1e02          	ldw	x,(OFST+1,sp)
2164  04dc a30210        	cpw	x,#528
2165  04df 2611          	jrne	L347
2166                     ; 464         if ((UART3->CR4 & (uint8_t)UART3_FLAG) != (uint8_t)0x00)
...
2199  0506               L557:
2200                     ; 485             status = RESET;
2202  0506 0f01          	clr	(OFST+0,sp)
2203  0508 201d          	jra	L157
2204  050a               L357:
2205                     ; 488     else if ((UART3_FLAG == UART3_FLAG_LHDF) || (UART3_FLAG == UART3_FLAG_LSF))
...
2214  0518               L567:
2215                     ; 490         if ((UART3->CR6 & (uint8_t)UART3_FLAG) != (uint8_t)0x00)
...
2226  0525               L767:
2227                     ; 498             status = RESET;
2229  0525 0f01          	clr	(OFST+0,sp)
2230  0527               L157:
2231                     ; 516     return  status;
2233  0527 7b01          	ld	a,(OFST+0,sp)
2236  0529 5b03          	addw	sp,#3
2237  052b 81            	ret
2238  052c               L367:
2239                     ; 503         if ((UART3->SR & (uint8_t)UART3_FLAG) != (uint8_t)0x00)
...
2250  0539               L577:
2251                     ; 511             status = RESET;
2253  0539 0f01          	clr	(OFST+0,sp)
2254  053b 20ea          	jra	L157
2290                     ; 546 void UART3_ClearFlag(UART3_Flag_TypeDef UART3_FLAG)
2290                     ; 547 {
2291                     	switch	.text
2292  053d               _UART3_ClearFlag:
2294  053d 89            	pushw	x
2295       00000000      OFST:	set	0
2298                     ; 549     assert_param(IS_UART3_CLEAR_FLAG_OK(UART3_FLAG));
...
2454                     ; 588     ITStatus pendingbitstatus = RESET;
2456                     ; 589     uint8_t itpos = 0;
2458                     ; 590     uint8_t itmask1 = 0;
2460                     ; 591     uint8_t itmask2 = 0;
2462                     ; 592     uint8_t enablestatus = 0;
2464                     ; 595     assert_param(IS_UART3_GET_IT_OK(UART3_IT));
...
2494  05cf               L622:
2495                     ; 598     itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)UART3_IT & (uint8_t)0x0F));
...
2510                     ; 600     itmask1 = (uint8_t)((uint8_t)UART3_IT >> (uint8_t)4);
2512  05e0 7b04          	ld	a,(OFST+2,sp)
2513  05e2 4e            	swap	a
2514  05e3 a40f          	and	a,#15
2515  05e5 6b02          	ld	(OFST+0,sp),a
2516                     ; 602     itmask2 = (uint8_t)((uint8_t)1 << itmask1);
...
2780                     	switch	.const
2781  0008               L741:
2782  0008 2e2e5c6c6962  	dc.b	"..\lib\src\stm8s_u"
2783  001a 617274332e63  	dc.b	"art3.c",0
2784                     	xref.b	c_lreg
2785                     	xref.b	c_x
2805                     	xref	c_lursh
2806                     	xref	c_lsub
