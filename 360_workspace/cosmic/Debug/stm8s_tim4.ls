 ...
 224  0054               L41:
 225                     ; 64     TIM4->PSCR = (uint8_t)(TIM4_Prescaler);
 227  0054 7b01          	ld	a,(OFST+1,sp)
 228  0056 c75345        	ld	21317,a
 229                     ; 66     TIM4->ARR = (uint8_t)(TIM4_Period);
 231  0059 7b02          	ld	a,(OFST+2,sp)
 232  005b c75346        	ld	21318,a
 233                     ; 67 }
 236  005e 85            	popw	x
 237  005f 81            	ret
 293                     ; 77 void TIM4_Cmd(FunctionalState NewState)
 293                     ; 78 {
 294                     	switch	.text
 295  0060               _TIM4_Cmd:
 297  0060 88            	push	a
 298       00000000      OFST:	set	0
 301                     ; 80     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 303  0061 4d            	tnz	a
 ...
 319  007b               L42:
 320                     ; 83     if (NewState != DISABLE)
 322  007b 0d01          	tnz	(OFST+1,sp)
 323  007d 2706          	jreq	L711
 324                     ; 85         TIM4->CR1 |= TIM4_CR1_CEN;
 326  007f 72105340      	bset	21312,#0
 328  0083 2004          	jra	L121
 329  0085               L711:
 330                     ; 89         TIM4->CR1 &= (uint8_t)(~TIM4_CR1_CEN);
 332  0085 72115340      	bres	21312,#0
 333  0089               L121:
 334                     ; 91 }
 337  0089 84            	pop	a
 338  008a 81            	ret
 397                     ; 103 void TIM4_ITConfig(TIM4_IT_TypeDef TIM4_IT, FunctionalState NewState)
 397                     ; 104 {
 398                     	switch	.text
 399  008b               _TIM4_ITConfig:
 401  008b 89            	pushw	x
 402       00000000      OFST:	set	0
 405                     ; 106     assert_param(IS_TIM4_IT_OK(TIM4_IT));
 407  008c 9e            	ld	a,xh
 ...
 421  00a4               L23:
 422                     ; 107     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 464  00d8 85            	popw	x
 465  00d9 81            	ret
 502                     ; 127 void TIM4_UpdateDisableConfig(FunctionalState NewState)
 502                     ; 128 {
 503                     	switch	.text
 504  00da               _TIM4_UpdateDisableConfig:
 506  00da 88            	push	a
 507       00000000      OFST:	set	0
 510                     ; 130     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 512  00db 4d            	tnz	a
 ...
 528  00f5               L05:
 529                     ; 133     if (NewState != DISABLE)
 531  00f5 0d01          	tnz	(OFST+1,sp)
 532  00f7 2706          	jreq	L571
 533                     ; 135         TIM4->CR1 |= TIM4_CR1_UDIS;
 535  00f9 72125340      	bset	21312,#1
 537  00fd 2004          	jra	L771
 538  00ff               L571:
 539                     ; 139         TIM4->CR1 &= (uint8_t)(~TIM4_CR1_UDIS);
 541  00ff 72135340      	bres	21312,#1
 542  0103               L771:
 543                     ; 141 }
 546  0103 84            	pop	a
 547  0104 81            	ret
 606                     ; 151 void TIM4_UpdateRequestConfig(TIM4_UpdateSource_TypeDef TIM4_UpdateSource)
 606                     ; 152 {
 607                     	switch	.text
 608  0105               _TIM4_UpdateRequestConfig:
 610  0105 88            	push	a
 611       00000000      OFST:	set	0
 614                     ; 154     assert_param(IS_TIM4_UPDATE_SOURCE_OK(TIM4_UpdateSource));
 616  0106 4d            	tnz	a
 ...
 632  0120               L06:
 633                     ; 157     if (TIM4_UpdateSource != TIM4_UPDATESOURCE_GLOBAL)
 635  0120 0d01          	tnz	(OFST+1,sp)
 636  0122 2706          	jreq	L722
 637                     ; 159         TIM4->CR1 |= TIM4_CR1_URS;
 639  0124 72145340      	bset	21312,#2
 641  0128 2004          	jra	L132
 642  012a               L722:
 643                     ; 163         TIM4->CR1 &= (uint8_t)(~TIM4_CR1_URS);
 645  012a 72155340      	bres	21312,#2
 646  012e               L132:
 647                     ; 165 }
 650  012e 84            	pop	a
 651  012f 81            	ret
 709                     ; 175 void TIM4_SelectOnePulseMode(TIM4_OPMode_TypeDef TIM4_OPMode)
 709                     ; 176 {
 710                     	switch	.text
 711  0130               _TIM4_SelectOnePulseMode:
 713  0130 88            	push	a
 714       00000000      OFST:	set	0
 717                     ; 178     assert_param(IS_TIM4_OPM_MODE_OK(TIM4_OPMode));
 ...
 735  014b               L07:
 736                     ; 181     if (TIM4_OPMode != TIM4_OPMODE_REPETITIVE)
 738  014b 0d01          	tnz	(OFST+1,sp)
 739  014d 2706          	jreq	L162
 740                     ; 183         TIM4->CR1 |= TIM4_CR1_OPM;
 742  014f 72165340      	bset	21312,#3
 744  0153 2004          	jra	L362
 745  0155               L162:
 746                     ; 187         TIM4->CR1 &= (uint8_t)(~TIM4_CR1_OPM);
 748  0155 72175340      	bres	21312,#3
 749  0159               L362:
 750                     ; 190 }
 753  0159 84            	pop	a
 754  015a 81            	ret
 823                     ; 212 void TIM4_PrescalerConfig(TIM4_Prescaler_TypeDef Prescaler, TIM4_PSCReloadMode_TypeDef TIM4_PSCReloadMode)
 823                     ; 213 {
 824                     	switch	.text
 825  015b               _TIM4_PrescalerConfig:
 827  015b 89            	pushw	x
 828       00000000      OFST:	set	0
 831                     ; 215     assert_param(IS_TIM4_PRESCALER_RELOAD_OK(TIM4_PSCReloadMode));
 833  015c 9f            	ld	a,xl
 834  015d 4d            	tnz	a
 ...
 851  0178               L001:
 852                     ; 216     assert_param(IS_TIM4_PRESCALER_OK(Prescaler));
 ...
 889  01b9               L601:
 890                     ; 219     TIM4->PSCR = (uint8_t)Prescaler;
 892  01b9 7b01          	ld	a,(OFST+1,sp)
 893  01bb c75345        	ld	21317,a
 894                     ; 222     TIM4->EGR = (uint8_t)TIM4_PSCReloadMode;
 896  01be 7b02          	ld	a,(OFST+2,sp)
 897  01c0 c75343        	ld	21315,a
 898                     ; 223 }
 901  01c3 85            	popw	x
 902  01c4 81            	ret
 939                     ; 231 void TIM4_ARRPreloadConfig(FunctionalState NewState)
 939                     ; 232 {
 940                     	switch	.text
 941  01c5               _TIM4_ARRPreloadConfig:
 943  01c5 88            	push	a
 944       00000000      OFST:	set	0
 947                     ; 234     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 949  01c6 4d            	tnz	a
 ...
 965  01e0               L611:
 966                     ; 237     if (NewState != DISABLE)
 968  01e0 0d01          	tnz	(OFST+1,sp)
 969  01e2 2706          	jreq	L533
 970                     ; 239         TIM4->CR1 |= TIM4_CR1_ARPE;
 972  01e4 721e5340      	bset	21312,#7
 974  01e8 2004          	jra	L733
 975  01ea               L533:
 976                     ; 243         TIM4->CR1 &= (uint8_t)(~TIM4_CR1_ARPE);
 978  01ea 721f5340      	bres	21312,#7
 979  01ee               L733:
 980                     ; 245 }
 983  01ee 84            	pop	a
 984  01ef 81            	ret
1034                     ; 254 void TIM4_GenerateEvent(TIM4_EventSource_TypeDef TIM4_EventSource)
1034                     ; 255 {
1035                     	switch	.text
1036  01f0               _TIM4_GenerateEvent:
1038  01f0 88            	push	a
1039       00000000      OFST:	set	0
1042                     ; 257     assert_param(IS_TIM4_EVENT_SOURCE_OK(TIM4_EventSource));
1044  01f1 a101          	cp	a,#1
1045  01f3 2603          	jrne	L221
1046  01f5 4f            	clr	a
1047  01f6 2010          	jra	L421
1048  01f8               L221:
1049  01f8 ae0101        	ldw	x,#257
...
1057  0208               L421:
1058                     ; 260     TIM4->EGR = (uint8_t)(TIM4_EventSource);
1060  0208 7b01          	ld	a,(OFST+1,sp)
1061  020a c75343        	ld	21315,a
1062                     ; 261 }
1065  020d 84            	pop	a
1066  020e 81            	ret
1100                     ; 270 void TIM4_SetCounter(uint8_t Counter)
1100                     ; 271 {
1101                     	switch	.text
1102  020f               _TIM4_SetCounter:
1106                     ; 273     TIM4->CNTR = (uint8_t)(Counter);
1108  020f c75344        	ld	21316,a
1109                     ; 274 }
1112  0212 81            	ret
1146                     ; 283 void TIM4_SetAutoreload(uint8_t Autoreload)
1146                     ; 284 {
1147                     	switch	.text
1148  0213               _TIM4_SetAutoreload:
1152                     ; 286     TIM4->ARR = (uint8_t)(Autoreload);
1154  0213 c75346        	ld	21318,a
1155                     ; 287 }
1158  0216 81            	ret
1181                     ; 294 uint8_t TIM4_GetCounter(void)
1181                     ; 295 {
1182                     	switch	.text
1183  0217               _TIM4_GetCounter:
1187                     ; 297     return (uint8_t)(TIM4->CNTR);
1189  0217 c65344        	ld	a,21316
1192  021a 81            	ret
1216                     ; 305 TIM4_Prescaler_TypeDef TIM4_GetPrescaler(void)
1216                     ; 306 {
1217                     	switch	.text
1218  021b               _TIM4_GetPrescaler:
1222                     ; 308     return (TIM4_Prescaler_TypeDef)(TIM4->PSCR);
1224  021b c65345        	ld	a,21317
1227  021e 81            	ret
1307                     ; 318 FlagStatus TIM4_GetFlagStatus(TIM4_FLAG_TypeDef TIM4_FLAG)
1307                     ; 319 {
1308                     	switch	.text
...
1316                     ; 320     FlagStatus bitstatus = RESET;
1318                     ; 323     assert_param(IS_TIM4_GET_FLAG_OK(TIM4_FLAG));
1320  0221 a101          	cp	a,#1
1321  0223 2603          	jrne	L041
1322  0225 4f            	clr	a
1323  0226 2010          	jra	L241
1324  0228               L041:
1325  0228 ae0143        	ldw	x,#323
...
1349  0247               L305:
1350                     ; 333   return ((FlagStatus)bitstatus);
1352  0247 7b01          	ld	a,(OFST+0,sp)
1355  0249 85            	popw	x
1356  024a 81            	ret
1392                     ; 343 void TIM4_ClearFlag(TIM4_FLAG_TypeDef TIM4_FLAG)
1392                     ; 344 {
1393                     	switch	.text
1394  024b               _TIM4_ClearFlag:
1396  024b 88            	push	a
1397       00000000      OFST:	set	0
1400                     ; 346     assert_param(IS_TIM4_GET_FLAG_OK(TIM4_FLAG));
1402  024c a101          	cp	a,#1
1403  024e 2603          	jrne	L641
1404  0250 4f            	clr	a
1405  0251 2010          	jra	L051
1406  0253               L641:
1407  0253 ae015a        	ldw	x,#346
...
1415  0263               L051:
1416                     ; 349     TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
...
1658  0000               L76:
1659  0000 2e2e5c6c6962  	dc.b	"..\lib\src\stm8s_t"
1660  0012 696d342e6300  	dc.b	"im4.c",0
1680                     	end
