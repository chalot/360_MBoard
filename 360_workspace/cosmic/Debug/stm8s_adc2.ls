  ...
  44                     ; 48 void ADC2_DeInit(void)
  44                     ; 49 {
  46                     	switch	.text
  47  0000               _ADC2_DeInit:
  51                     ; 50     ADC2->CSR  = ADC2_CSR_RESET_VALUE;
  53  0000 725f5400      	clr	21504
  54                     ; 51     ADC2->CR1  = ADC2_CR1_RESET_VALUE;
  56  0004 725f5401      	clr	21505
  57                     ; 52     ADC2->CR2  = ADC2_CR2_RESET_VALUE;
  59  0008 725f5402      	clr	21506
  60                     ; 53     ADC2->TDRH = ADC2_TDRH_RESET_VALUE;
  62  000c 725f5406      	clr	21510
  63                     ; 54     ADC2->TDRL = ADC2_TDRL_RESET_VALUE;
  65  0010 725f5407      	clr	21511
  66                     ; 55 }
  69  0014 81            	ret
 596                     ; 77 void ADC2_Init(ADC2_ConvMode_TypeDef ADC2_ConversionMode, ADC2_Channel_TypeDef ADC2_Channel, ADC2_PresSel_TypeDef ADC2_PrescalerSelection, ADC2_ExtTrig_TypeDef ADC2_ExtTrigger, FunctionalState ADC2_ExtTriggerState, ADC2_Align_TypeDef ADC2_Align, ADC2_SchmittTrigg_TypeDef ADC2_SchmittTriggerChannel, FunctionalState ADC2_SchmittTriggerState)
 596                     ; 78 {
 597                     	switch	.text
 598  0015               _ADC2_Init:
 600  0015 89            	pushw	x
 601       00000000      OFST:	set	0
 604                     ; 81     assert_param(IS_ADC2_CONVERSIONMODE_OK(ADC2_ConversionMode));
 606  0016 9e            	ld	a,xh
 607  0017 4d            	tnz	a
 ...
 624  0032               L41:
 625                     ; 82     assert_param(IS_ADC2_CHANNEL_OK(ADC2_Channel));
 ...
 686  00a3               L22:
 687                     ; 83     assert_param(IS_ADC2_PRESSEL_OK(ADC2_PrescalerSelection));
 ...
 724  00e4               L03:
 725                     ; 84     assert_param(IS_ADC2_EXTTRIG_OK(ADC2_ExtTrigger));
 ...
 744  0101               L63:
 745                     ; 85     assert_param(IS_FUNCTIONALSTATE_OK(((ADC2_ExtTriggerState))));
 ...
 764  011e               L44:
 765                     ; 86     assert_param(IS_ADC2_ALIGN_OK(ADC2_Align));
 ...
 784  013b               L25:
 785                     ; 87     assert_param(IS_ADC2_SCHMITTTRIG_OK(ADC2_SchmittTriggerChannel));
 ...
 849  01b2               L06:
 850                     ; 88     assert_param(IS_FUNCTIONALSTATE_OK(ADC2_SchmittTriggerState));
 ...
 869  01cf               L66:
 870                     ; 93     ADC2_ConversionConfig(ADC2_ConversionMode, ADC2_Channel, ADC2_Align);
 ...
 880  01db 84            	pop	a
 881                     ; 95     ADC2_PrescalerConfig(ADC2_PrescalerSelection);
 883  01dc 7b05          	ld	a,(OFST+5,sp)
 884  01de ad6e          	call	_ADC2_PrescalerConfig
 886                     ; 100     ADC2_ExternalTriggerConfig(ADC2_ExtTrigger, ADC2_ExtTriggerState);
 888  01e0 7b07          	ld	a,(OFST+7,sp)
 889  01e2 97            	ld	xl,a
 890  01e3 7b06          	ld	a,(OFST+6,sp)
 891  01e5 95            	ld	xh,a
 892  01e6 cd047f        	call	_ADC2_ExternalTriggerConfig
 894                     ; 105     ADC2_SchmittTriggerConfig(ADC2_SchmittTriggerChannel, ADC2_SchmittTriggerState);
 896  01e9 7b0a          	ld	a,(OFST+10,sp)
 897  01eb 97            	ld	xl,a
 898  01ec 7b09          	ld	a,(OFST+9,sp)
 899  01ee 95            	ld	xh,a
 900  01ef cd0293        	call	_ADC2_SchmittTriggerConfig
 902                     ; 108     ADC2->CR1 |= ADC2_CR1_ADON;
 904  01f2 72105401      	bset	21505,#0
 905                     ; 110 }
 908  01f6 85            	popw	x
 909  01f7 81            	ret
 945                     ; 118 void ADC2_Cmd(FunctionalState NewState)
 945                     ; 119 {
 946                     	switch	.text
 947  01f8               _ADC2_Cmd:
 949  01f8 88            	push	a
 950       00000000      OFST:	set	0
 953                     ; 122     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 955  01f9 4d            	tnz	a
 ...
 971  0213               L67:
 972                     ; 124     if (NewState != DISABLE)
 974  0213 0d01          	tnz	(OFST+1,sp)
 975  0215 2706          	jreq	L113
 976                     ; 126         ADC2->CR1 |= ADC2_CR1_ADON;
 978  0217 72105401      	bset	21505,#0
 980  021b 2004          	jra	L313
 981  021d               L113:
 982                     ; 130         ADC2->CR1 &= (uint8_t)(~ADC2_CR1_ADON);
 984  021d 72115401      	bres	21505,#0
 985  0221               L313:
 986                     ; 133 }
 989  0221 84            	pop	a
 990  0222 81            	ret
1026                     ; 140 void ADC2_ITConfig(FunctionalState NewState)
1026                     ; 141 {
1027                     	switch	.text
...
1070  024c 84            	pop	a
1071  024d 81            	ret
1108                     ; 165 void ADC2_PrescalerConfig(ADC2_PresSel_TypeDef ADC2_Prescaler)
1108                     ; 166 {
1109                     	switch	.text
1110  024e               _ADC2_PrescalerConfig:
1112  024e 88            	push	a
1113       00000000      OFST:	set	0
1116                     ; 169     assert_param(IS_ADC2_PRESSEL_OK(ADC2_Prescaler));
1118  024f 4d            	tnz	a
...
1146  0281               L611:
1147                     ; 172     ADC2->CR1 &= (uint8_t)(~ADC2_CR1_SPSEL);
1149  0281 c65401        	ld	a,21505
1150  0284 a48f          	and	a,#143
1151  0286 c75401        	ld	21505,a
1152                     ; 174     ADC2->CR1 |= (uint8_t)(ADC2_Prescaler);
...
1160  0291 84            	pop	a
1161  0292 81            	ret
1209                     ; 187 void ADC2_SchmittTriggerConfig(ADC2_SchmittTrigg_TypeDef ADC2_SchmittTriggerChannel, FunctionalState NewState)
1209                     ; 188 {
1210                     	switch	.text
1211  0293               _ADC2_SchmittTriggerConfig:
1213  0293 89            	pushw	x
1214       00000000      OFST:	set	0
1217                     ; 191     assert_param(IS_ADC2_SCHMITTTRIG_OK(ADC2_SchmittTriggerChannel));
...
1282  02fb               L621:
1283                     ; 192     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
1360  035e               L114:
1361                     ; 215             ADC2->TDRL |= (uint8_t)((uint8_t)0x01 << (uint8_t)ADC2_SchmittTriggerChannel);
...
1377  0373               L704:
1378                     ; 220         if (NewState != DISABLE)
1380  0373 0d02          	tnz	(OFST+2,sp)
1381  0375 2718          	jreq	L714
1382                     ; 222             ADC2->TDRH &= (uint8_t)(~(uint8_t)((uint8_t)0x01 << ((uint8_t)ADC2_SchmittTriggerChannel - (uint8_t)8)));
...
1401  038f               L714:
1402                     ; 226             ADC2->TDRH |= (uint8_t)((uint8_t)0x01 << ((uint8_t)ADC2_SchmittTriggerChannel - (uint8_t)8));
...
1422  03a4 85            	popw	x
1423  03a5 81            	ret
1481                     ; 242 void ADC2_ConversionConfig(ADC2_ConvMode_TypeDef ADC2_ConversionMode, ADC2_Channel_TypeDef ADC2_Channel, ADC2_Align_TypeDef ADC2_Align)
1481                     ; 243 {
1482                     	switch	.text
1483  03a6               _ADC2_ConversionConfig:
1485  03a6 89            	pushw	x
1486       00000000      OFST:	set	0
1489                     ; 246     assert_param(IS_ADC2_CONVERSIONMODE_OK(ADC2_ConversionMode));
...
1509  03c3               L461:
1510                     ; 247     assert_param(IS_ADC2_CHANNEL_OK(ADC2_Channel));
...
1571  0434               L271:
1572                     ; 248     assert_param(IS_ADC2_ALIGN_OK(ADC2_Align));
...
1628  047d 85            	popw	x
1629  047e 81            	ret
1676                     ; 284 void ADC2_ExternalTriggerConfig(ADC2_ExtTrig_TypeDef ADC2_ExtTrigger, FunctionalState NewState)
1676                     ; 285 {
1677                     	switch	.text
1678  047f               _ADC2_ExternalTriggerConfig:
1680  047f 89            	pushw	x
1681       00000000      OFST:	set	0
1684                     ; 288     assert_param(IS_ADC2_EXTTRIG_OK(ADC2_ExtTrigger));
...
1704  049c               L012:
1705                     ; 289     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
1752  04d7 85            	popw	x
1753  04d8 81            	ret
1777                     ; 320 void ADC2_StartConversion(void)
1777                     ; 321 {
1778                     	switch	.text
1779  04d9               _ADC2_StartConversion:
1783                     ; 322     ADC2->CR1 |= ADC2_CR1_ADON;
1785  04d9 72105401      	bset	21505,#0
1786                     ; 323 }
1789  04dd 81            	ret
1833                     ; 332 uint16_t ADC2_GetConversionValue(void)
1833                     ; 333 {
1834                     	switch	.text
1835  04de               _ADC2_GetConversionValue:
1837  04de 5205          	subw	sp,#5
1838       00000005      OFST:	set	5
1841                     ; 335     uint16_t temph = 0;
1843                     ; 336     uint8_t templ = 0;
1845                     ; 338     if ((ADC2->CR2 & ADC2_CR2_ALIGN) != 0) /* Right alignment */
1847  04e0 c65402        	ld	a,21506
1848  04e3 a508          	bcp	a,#8
1849  04e5 2715          	jreq	L535
1850                     ; 341         templ = ADC2->DRL;
1852  04e7 c65405        	ld	a,21509
1853  04ea 6b03          	ld	(OFST-2,sp),a
1854                     ; 343         temph = ADC2->DRH;
1856  04ec c65404        	ld	a,21508
1857  04ef 5f            	clrw	x
1858  04f0 97            	ld	xl,a
1859  04f1 1f04          	ldw	(OFST-1,sp),x
1860                     ; 345         temph = (uint16_t)(templ | (uint16_t)(temph << (uint8_t)8));
1862  04f3 1e04          	ldw	x,(OFST-1,sp)
1863  04f5 7b03          	ld	a,(OFST-2,sp)
1864  04f7 02            	rlwa	x,a
1865  04f8 1f04          	ldw	(OFST-1,sp),x
1867  04fa 2021          	jra	L735
1868  04fc               L535:
1869                     ; 350         temph = ADC2->DRH;
1871  04fc c65404        	ld	a,21508
1872  04ff 5f            	clrw	x
1873  0500 97            	ld	xl,a
1874  0501 1f04          	ldw	(OFST-1,sp),x
1875                     ; 352         templ = ADC2->DRL;
1877  0503 c65405        	ld	a,21509
1878  0506 6b03          	ld	(OFST-2,sp),a
1879                     ; 354         temph = (uint16_t)((uint16_t)((uint16_t)templ << 6) | (uint16_t)((uint16_t)temph << 8));
1881  0508 1e04          	ldw	x,(OFST-1,sp)
1882  050a 4f            	clr	a
1883  050b 02            	rlwa	x,a
1884  050c 1f01          	ldw	(OFST-4,sp),x
1885  050e 7b03          	ld	a,(OFST-2,sp)
1886  0510 97            	ld	xl,a
1887  0511 a640          	ld	a,#64
1888  0513 42            	mul	x,a
1889  0514 01            	rrwa	x,a
1890  0515 1a02          	or	a,(OFST-3,sp)
1891  0517 01            	rrwa	x,a
1892  0518 1a01          	or	a,(OFST-4,sp)
1893  051a 01            	rrwa	x,a
1894  051b 1f04          	ldw	(OFST-1,sp),x
1895  051d               L735:
1896                     ; 357     return ((uint16_t)temph);
1898  051d 1e04          	ldw	x,(OFST-1,sp)
1901  051f 5b05          	addw	sp,#5
1902  0521 81            	ret
1946                     ; 366 FlagStatus ADC2_GetFlagStatus(void)
1946                     ; 367 {
1947                     	switch	.text
1948  0522               _ADC2_GetFlagStatus:
1952                     ; 369     return (FlagStatus)(ADC2->CSR & ADC2_CSR_EOC);
1954  0522 c65400        	ld	a,21504
1955  0525 a480          	and	a,#128
1958  0527 81            	ret
1981                     ; 378 void ADC2_ClearFlag(void)
1981                     ; 379 {
1982                     	switch	.text
1983  0528               _ADC2_ClearFlag:
1987                     ; 380     ADC2->CSR &= (uint8_t)(~ADC2_CSR_EOC);
1989  0528 721f5400      	bres	21504,#7
1990                     ; 381 }
1993  052c 81            	ret
2017                     ; 389 ITStatus ADC2_GetITStatus(void)
2017                     ; 390 {
2018                     	switch	.text
2019  052d               _ADC2_GetITStatus:
2023                     ; 391     return (ITStatus)(ADC2->CSR & ADC2_CSR_EOC);
2025  052d c65400        	ld	a,21504
2026  0530 a480          	and	a,#128
2029  0532 81            	ret
2053                     ; 399 void ADC2_ClearITPendingBit(void)
2053                     ; 400 {
2054                     	switch	.text
2055  0533               _ADC2_ClearITPendingBit:
2059                     ; 401     ADC2->CSR &= (uint8_t)(~ADC2_CSR_EOC);
2061  0533 721f5400      	bres	21504,#7
2062                     ; 402 }
2065  0537 81            	ret
2078                     	xdef	_ADC2_ClearITPendingBit
2079                     	xdef	_ADC2_GetITStatus
2080                     	xdef	_ADC2_ClearFlag
2081                     	xdef	_ADC2_GetFlagStatus
2082                     	xdef	_ADC2_GetConversionValue
2083                     	xdef	_ADC2_StartConversion
2084                     	xdef	_ADC2_ExternalTriggerConfig
2085                     	xdef	_ADC2_ConversionConfig
2086                     	xdef	_ADC2_SchmittTriggerConfig
2087                     	xdef	_ADC2_PrescalerConfig
2088                     	xdef	_ADC2_ITConfig
2089                     	xdef	_ADC2_Cmd
2090                     	xdef	_ADC2_Init
2091                     	xdef	_ADC2_DeInit
2092                     	xref	_assert_failed
2093                     .const:	section	.text
2094  0000               L172:
2095  0000 2e2e5c6c6962  	dc.b	"..\lib\src\stm8s_a"
2096  0012 6463322e6300  	dc.b	"dc2.c",0
2116                     	end
